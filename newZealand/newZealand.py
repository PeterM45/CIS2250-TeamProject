...
# Read baby names
df = pd.read_csv("./newZealand/baby-names-2023-01-09.csv")
...
).to_csv("./newZealand/newZealandMales.csv", index=False, line_terminator="\n")
girls_df[["Rank", "Year", "Name", "Count"]].rename(
    columns={"Count": "Frequency"}
).to_csv("newZealand/newZealandFemales.csv", index=False, line_terminator="\n")
